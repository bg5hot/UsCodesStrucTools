...
3. **阵风响应因子G** - ASCE 7-16 Section 26.11风振系数计算
4. **单筋混凝土梁** - ACI 318-25梁截面受弯受剪设计
5. **混凝土矩形柱** - ACI 318-19矩形柱双向偏压设计（P-M交互图、抗剪验算）
6. **混凝土圆形柱** - ACI 318-19圆形柱双向偏压设计（支持螺旋箍筋）
7. **双向板抗冲切** - ACI 318-19板柱节点抗冲切验算（支持抗剪栓钉/箍筋）
8. **关注公众号** - 显示公众号二维码
